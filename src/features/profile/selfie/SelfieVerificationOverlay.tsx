    ...
    <>
      {visible && step === "camera" && (
        <Host>
          {attempt ? (
            <SelfieCameraStep
              // Yeni attempt = SIFIRDAN çekim. `attempt_expired` otomatik
              // yeniden başlatmasında `step` "camera"da kaldığı için bileşen
              // kendiliğinden unmount olmuyor; key olmadan iç `index`i son
              // karede takılı kalır ve kullanıcı challenge sayısından az kare
              // çekip UT-6507'ye düşerdi.

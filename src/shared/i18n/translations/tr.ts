const tr = {
  ...
  auth: {
    ...
    step9: {
      title: 'Konum Bilgilerin',
      description: 'Yaşadığın şehri ve ilçeni seç.',
      skipButton: 'Atla',
      cityLabel: 'Şehir',
      ...
      validation: {
        cityFirst: 'Lütfen önce şehir seçin',
      },
    },
    step10: {
      title: 'İlgi Alanın',
  ...
  discover: {
    ...
    filters: {
      ...
      maxDistance: {
        ...
        descPremium: 'Eşleşmek istediğin kullanıcıların maksimum uzaklığını belirle. Daireyi parmağınla sürükleyerek ayarlayabilirsin.',
        descFree: 'Eşleşmek istediğin kullanıcıların maksimum uzaklığını belirle. Ücretsiz üyelikte bu mesafe {{limit}} km ile sınırlıdır; daha geniş bir aralık için Premium üyelik gerekir.',
      },
      gender: {
        title: 'Cinsiyet',
  ...
  profile: {
    ...
    edit: {
      ...
      missingInterests: 'En az bir ilgi alanı seçmelisin.',

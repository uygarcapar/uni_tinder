const en = {
  ...
  auth: {
    ...
    step9: {
      title: 'Your Location',
      description: 'Select the city and district you live in.',
      skipButton: 'Skip',
      cityLabel: 'City',
      ...
      validation: {
        cityFirst: 'Please select a city first',
      },
    },
    step10: {
      title: 'Interests',
    ...
    register: {
      ...
      validation: {
        nameRequired: 'Please fill in the first and last name fields',
        genderRequired: 'Please select your gender',
        passwordRequired: 'Please fill in the password fields',
        passwordMismatch: 'Passwords do not match',
        passwordTooShort: 'Password must be at least 8 characters',
        phoneRequired: 'Please enter your phone number',
        emailRequired: 'Please enter your university email address',
      },
  ...
  discover: {
    ...
    filters: {
      ...
      maxDistance: {
        ...
        descPremium: 'Set the maximum distance for users you want to match with. Drag the circle with your finger to adjust.',
        descFree: 'Set the maximum distance for users you want to match with. Free membership is limited to {{limit}} km; Premium membership is required for a wider range.',
      },
      gender: {
        title: 'Gender',
        description: 'Select which gender users you want to see.',
        male: 'Male',
        female: 'Female',
        nonBinary: 'Non-Binary',
        other: 'Other',
  ...
  profile: {
    ...
    edit: {
      ...
      missingInterests: 'You must select at least one interest.',
  ...
  chatUnlock: {
    title: 'Unlock Chat',
    heroTitle: "You've reached the 50 message limit",
    heroSubtitle: 'Unlock this chat once and both of you can message without limits.',
    feature1: 'Unlimited messaging in this chat',
    feature2: 'One-time purchase — not a subscription',
    feature3: 'Other chats are not affected',
    cta: '{{price}} — Unlock Chat',
    disclaimer: 'One-time purchase. No renewal, no automatic charges. If you both become Premium, this chat will be unlimited anyway.',
    notAvailable: 'Package not available right now. Please try again later.',
    errors: {
      packageNotFound: 'Package not found.',
      chatNotSelected: 'Chat not selected.',
      verificationFailed: "Purchase completed but verification info could not be retrieved. Please try the 'Restore' button.",
      purchaseTitle: 'Purchase Error',
    },
  },
  moderation: {
